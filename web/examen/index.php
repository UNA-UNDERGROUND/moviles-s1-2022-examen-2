                            ...
                            <div class="row">
                                <div class="col">
                                    <div class="row">
                                        <!--username-->
                                        <div class="col">
                                            <div id="div-name-trainingPlan" class="form-group">
                                                <label for="name-trainingPlan">Nombre de usuario</label>
                                                <input type="text" id="trainingPlanUserName" name="trainingPlanUserName" class="form-control">
                                            </div>
                                        </div>
                                        <div class="col">
                                        ...
                                        <div class="col">
                                            <div class="form-group" id="div-day">
                                                ...
                                                <select name="day" class="form-control" id="day">
                                                    ...
                                                    <option value="U">S&Aacute;BADO</option>
